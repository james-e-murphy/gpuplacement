...
**Ledger status:** Updated for `v1.0.0` on 2026-07-17. Every distinct provider/SKU assumption points to a primary source, an official dynamic pricing interface, or an explicit unverified/modeled classification. The rate conflicts identified in the first provider pass were corrected or visibly disclosed before release.
...
| CW-PRICING | CoreWeave pricing, current platform | https://www.coreweave.com/pricing | Node list prices by continent; per GPU rates derived by dividing by eight. Page content provided directly by the author on 2026-07-17; archive the page for the v1.0.1 evidence set. Confirms free egress and advertises reserved discounts of up to 60 percent as contact sales. |
...
A row covers all listed tool region codes when the same price assumption is repeated. Values are dollars per GPU-hour. A value of n/a means the tool does not display that mode.
...
|---|---|---|---|---:|---:|---:|---:|---|---|---|
| B300 | RunPod | B300 Secure Cloud | rp-us-east; rp-us-west | 7.39 | n/a | n/a | n/a | RUNPOD | On-demand: published match | Pods page directly lists $7.39/hr. Region labels are tool proxies, not rate-specific evidence. |
| B300 | Nebius | B300 SXM | nebius-us-east; nebius-us-central | 7.85 | n/a | n/a | 4.30 | NEBIUS | On-demand and preemptible: published matches | Named rows are carbon-location proxies; the public headline page does not substantiate region-specific price or inventory. |
| B300 | CoreWeave | HGX B300 /8 | cw-us-east; cw-us-west | n/a | n/a | n/a | 4.48 | CW-PRICING | Spot: derived from published node price | Added for v1.0.0. On demand is contact sales; spot $35.84 North America node price divided by eight. The page lists 270GB VRAM; the tier label keeps the NVIDIA 288GB specification. |
| H200 | AWS | p5en.48xlarge /8 | us-east-1; us-west-2 | 7.91 | 5.14 | 3.56 | n/a | AWS-OD; AWS-SP | Snapshot required | All displayed rates require official catalog/calculator export. Commitment values are modeled until term/payment evidence is attached. |
...
| H200 | CoreWeave | HGX H200 /8 | cw-us-east; cw-us-west | 6.31 | n/a | n/a | 2.62 | CW-PRICING | On-demand and spot: derived from published node prices | Restored for v1.0.0. $50.44 and $20.93 North America node prices divided by eight. The page prices by continent; both named locations use the North America rate. Reserved is contact sales. |
...
| H200 | Crusoe | H200 HGX | crusoe-tx; crusoe-va | 4.29 | 3.43 | 2.57 | n/a | CRUSOE | On-demand: published match; commitments unsupported | Current public page lists on demand $4.29 and contact-sales for spot. Commitment values are estimates. |
| H200 | Nebius | H200 SXM | nebius-us-east; nebius-us-central | 4.50 | n/a | n/a | 2.45 | NEBIUS | On-demand and preemptible: published matches | Added for v1.0.0 from the live price page. Named rows are carbon-location proxies; no region-differentiated public price was identified. |
...
| B200 | GCP | a4-highgpu /8 | us-central1; us-east4 | n/a | 11.12 | 7.09 | 4.28 | GCP-A3A4; GCP-CUD; GCP-SPOT | Snapshot required; construct mapping review | The tool intentionally has no on demand value. Verify whether each displayed mode corresponds to reservation, flex-start/DWS, CUD or Spot. |
| B200 | CoreWeave | HGX B200 /8 | cw-us-east; cw-us-west | 8.60 | n/a | n/a | 4.26 | CW-PRICING | On-demand and spot: derived from published node prices | Restored for v1.0.0. $68.80 and $34.11 North America node prices divided by eight. Page lists 180GB VRAM, matching the corrected tier label. |
| B200 | Lambda Labs | B200 SXM6 | lambda-us-east; lambda-us-west | 6.69 | n/a | n/a | n/a | LAMBDA | On-demand: published match | The $6.69 rate is the 8-GPU tier; smaller instance sizes cost more per GPU. |
| B200 | RunPod | B200 Secure Cloud | rp-us-east; rp-us-west | 5.89 | 5.01 | n/a | n/a | RUNPOD | On-demand: published match; commitment unsupported | Reserved Clusters are contact-sales; $5.01 is not directly published on the current page. |
| B200 | Nebius | B200 SXM | nebius-us-east; nebius-us-central | 7.15 | n/a | n/a | 3.95 | NEBIUS | On-demand and preemptible: published matches | Corrected during release review. Named rows are carbon-location proxies; no region-differentiated public price was identified. |
...
| L40S | CoreWeave | L40S 8 GPU node /8 | cw-us-east; cw-us-west | 2.25 | n/a | n/a | 0.99 | CW-PRICING | On-demand and spot: derived from published node prices | Restored for v1.0.0. $18.00 and $7.88 node prices divided by eight; spot is 0.985 exact, shown as 0.99. The prior carried 1.40 matched no current public row. |
...
| L40S | Crusoe | L40S | crusoe-tx; crusoe-va | 1.50 | 1.20 | 0.90 | n/a | CRUSOE | On-demand: published match; commitments unsupported | Current page lists $1.50 on demand and contact-sales for spot. Commitment values are estimates. |
...
| H100 | Lambda Labs | H100 SXM | lambda-us-east; lambda-us-west | 3.99 | 3.39 | 2.99 | n/a | LAMBDA | On-demand: published match; commitments unsupported | $3.99 is the 8-GPU tier. Reserved pricing is contact-sales; commitment values are estimates. |
...
| H100 | RunPod | H100 SXM | rp-us-east; rp-us-west | 2.99 | 2.24 | 2.24 | 1.73 | RUNPOD | On-demand: published match; other modes modeled | Corrected during release review. Reserved Clusters are contact-sales; commitment and interruptible values are scenario discounts, not provider offers. |
| H100 | Crusoe | H100 HGX | crusoe-tx; crusoe-va | 3.90 | 3.12 | 2.34 | n/a | CRUSOE | On-demand: published match; commitments unsupported | Current page lists $3.90 on demand and contact-sales for spot. Commitment values are estimates. |
| H100 | Nebius | H100 SXM | nebius-us-east; nebius-us-central | 3.85 | n/a | n/a | 2.15 | NEBIUS | On-demand and preemptible: published matches | Named rows are carbon-location proxies unless region-specific availability evidence is attached. |
...
| A100 | GCP | a2-ultragpu-1g | us-central1; us-east4 | 5.07 | n/a | n/a | 2.53 | GCP-A3A4; GCP-SPOT | Snapshot required | Confirm A2 machine shape and whether the displayed amount includes all mandatory machine resources. |
...
| A100 | Lambda Labs | A100 SXM 80GB | lambda-us-east; lambda-us-west | 2.79 | 2.37 | 2.09 | n/a | LAMBDA | On-demand: published match; commitments unsupported | $2.79 is the 8-GPU 80GB SXM tier. Commitment values are estimates. |
...
| A100 | Crusoe | A100 80GB SXM | crusoe-tx; crusoe-va | 2.30 | 1.84 | 1.38 | n/a | CRUSOE | On-demand: published match; commitments unsupported | Current page lists $2.30 on demand and contact-sales for spot. Commitment values are estimates. |
...
| L4 proxy | GCP | g2-standard-4 | us-central1; us-east4; us-west1 | 0.707 | 0.445 | 0.318 | 0.311 | GCP-A3A4; GCP-CUD; GCP-SPOT | Snapshot required; hardware identity disclosed | The tier is labeled `A10G / L4 (24GB)`. The GCP machine uses NVIDIA L4 and is included as a comparable 24GB alternative, not as an A10G SKU. |
...
| A10 | CoreWeave | n/a | cw-us-east; cw-us-west | n/a | n/a | n/a | n/a | CW-PRICING | Unavailable | The current pricing page lists no A10 class product. The row returns only if one reappears publicly. |
...
## E. Source-validation resolution and remaining findings

### Corrected or disclosed during release review
...
7. **Modeled commercial discounts:** the tooltip, mobile ranking and CSV state the rate basis; modeled/unverified values receive an amber diamond chart marker.
...
9. **Nebius H200:** added $4.50 on demand and $2.45 preemptible from the live price page.
10. **B200 memory label:** corrected from 192GB to 180GB per the NVIDIA HGX B200 product carbon footprint summary and shipped OEM product guides.
11. **CoreWeave H200, B200, L40S and A10:** carried values set unavailable. The ledger required primary evidence or removal for these rows and removal was chosen.
12. **CoreWeave H200, B200 and L40S restored:** on demand and spot derived from current pricing page node rates provided by the author. A10 remains unavailable; the current page lists no A10 class product.
13. **CoreWeave B300 added:** spot only at 4.48; on demand is contact sales.

### Release scope for v1.0.0

1. **Hyperscaler catalog archives:** dated AWS, Azure, GCP and OCI exports are tracked for v1.0.1. They do not gate v1.0.0; every affected row carries its evidence label in the tooltip, mobile ranking and CSV until the archive set lands.
2. **CoreWeave:** H200, B200 and L40S returned for v1.0.0 with on demand and spot derived from the current pricing page, and a spot only B300 row was added. A10 remains unavailable; the current page lists no A10 class product. Commitment fields stay empty; reserved capacity is contact sales with an advertised ceiling of up to 60 percent.
3. **Modeled commitment and spot values:** retained as labeled analytical scenarios. Replace with current quotes for any submitted worked example.
4. **Regional availability:** a repeated national price does not imply that the SKU is available in each named location; proxy rows say so in their notes.
5. **Grid mapping record:** the per location mapping table for METHODOLOGY section 7 is tracked for v1.0.1.
...
v1.0.0 ships with the evidence labels as the disclosure mechanism. Published and derived values trace to the sources in this ledger. Dynamic snapshot values are labeled as such in the product wherever a dated archive is not yet attached. The items listed under Release scope are tracked for v1.0.1 and recorded in the changelog.
