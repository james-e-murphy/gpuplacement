...
- CoreWeave H100 and A100 values in rc3 use the minimum valid a-la-carte configuration. They are cost floors, not recommended or representative production shapes.
- An amber evidence halo identifies modeled, unverified or dynamic-snapshot-dependent rates; it does not validate availability or commercial eligibility.
...
- Annual TCO carbon is an active use proxy scaled by utilization in the release candidate.
